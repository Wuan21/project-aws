...
![Ảnh 1](/project-aws/images/5-Workshop/5.5/5.5.1.png)
2. Trên menu bên trái chọn **Roles**, nhấp chọn **Create role**.
![Ảnh 2](/project-aws/images/5-Workshop/5.5/5.5.2.png)
3. **Step 1 - Select trusted entity:**
   * **Trusted entity type:** Chọn **AWS service**.
   * **Service or use case:** Chọn **Lambda** từ danh sách.
   * Nhấn **Next**.
   ![Ảnh 3](/project-aws/images/5-Workshop/5.5/5.5.3.png)
4. **Step 2 - Add permissions:**
   ...
   * Nhấn **Next**.
   ![Ảnh 4](/project-aws/images/5-Workshop/5.5/5.5.4.png)
5. **Step 3 - Name, review, and create:**
   * **Role name:** Nhập `webquiz-dev-lambda-role`.
   * Nhấp chọn **Create role**.
   ![Ảnh 5](/project-aws/images/5-Workshop/5.5/5.5.5.png)
---
...
3. Chọn tab **JSON** và dán chính sách phân quyền sau:
   ...
   ```
   ![Ảnh 6](/project-aws/images/5-Workshop/5.5/5.5.6.png)
4. Nhấn **Next**.
...
![Ảnh 7](/project-aws/images/5-Workshop/5.5/5.5.7.png)
2. Trên menu bên trái chọn **Event buses**, nhấp chọn **Create event bus**.
![Ảnh 8](/project-aws/images/5-Workshop/5.5/5.5.8.png)
3. Trong biểu mẫu khởi tạo:
 ...
 ![Ảnh 9](/project-aws/images/5-Workshop/5.5/5.5.9.png)
 ![Ảnh 10](/project-aws/images/5-Workshop/5.5/5.5.10.png)
