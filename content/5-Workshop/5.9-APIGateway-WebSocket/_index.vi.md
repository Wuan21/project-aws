...
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.1.png)
3. Tại phần **Choose an API type**, tìm **WebSocket API** và nhấp chọn **Build**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.2.png)
...
1. Tại bước **Add routes**:
   ...
   * Tick chọn ✅ **$default**
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.3.png)
2. Nhấn **Next**.
...
1. Thiết lập các integration:
   ...
   * Đối với route **`$default`**:
     ...
     * **Lambda function:** Chọn `webquiz-dev-ws-message`.
     ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.4.png)
2. Nhấn **Next**.
...
1. **Step 4 - Add stages:**
   ...
   * Tick chọn ✅ **Auto deploy**.
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.5.png)
   * Nhấn **Next**.
...
*   **Connections URL:**
    ...
    *(Sử dụng phía hàm Lambda backend để thực hiện phát/broadcast tin nhắn).*
    ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.6.png)
...
2. Cập nhật hàm **`webquiz-dev-ws-message`**:
   ...
   * Nhấn **Save**.
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.7.png)
3. Cập nhật hàm **`webquiz-dev-score-calculator`**:
   ...
   * Nhấn **Save**.
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.9/5.9.8.png)
