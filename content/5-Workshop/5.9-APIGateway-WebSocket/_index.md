...
2. Click **Create API**.
![Image 1](/project-aws/images/5-Workshop/5.9/5.9.1.png)
3. Under **Choose an API type**, find **WebSocket API** and click **Build**.
![Image 2](/project-aws/images/5-Workshop/5.9/5.9.2.png)
4. Configure API details:
   ...
   * Click **Next**.
![Image 3](/project-aws/images/5-Workshop/5.9/5.9.3.png)
...
![Image 4](/project-aws/images/5-Workshop/5.9/5.9.4.png)
2. Click **Next**.
...
1. **Step 4 - Add stages:**
   ...
   * Check ✅ **Auto-deploy**.
   * Click **Next**.
![Image 5](/project-aws/images/5-Workshop/5.9/5.9.5.png)
...
![Image 6](/project-aws/images/5-Workshop/5.9/5.9.6.png)
...
2. Update the **`webquiz-dev-ws-message`** function:
   ...
   * Click **Save**.
![Image 7](/project-aws/images/5-Workshop/5.9/5.9.7.png)
3. Update the **`webquiz-dev-score-calculator`** function:
   ...
   * Click **Save**.
![Image 8](/project-aws/images/5-Workshop/5.9/5.9.8.png)
