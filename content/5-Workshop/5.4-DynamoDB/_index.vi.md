...
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.1.png)
...
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.2.png)
...
6. Tại phần **Secondary indexes**, nhấp chọn **Create global index**:
   ...
   * Nhấp chọn **Create index**.
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.3.png)
7. Giữ các thông số mã hóa mặc định, nhấp chọn **Create table**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.4.png)
...
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.5.png)
3. Tại phần **Secondary indexes**, nhấp chọn **Create global index**:
   ...
   * Nhấp chọn **Create index**.
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.6.png)
4. Nhấp chọn **Create table**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.7.png)
...
2. Chọn **Customize settings** → Cấu hình co giãn **On-demand**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.8.png)
...
2. Chọn **Customize settings** → Cấu hình co giãn **On-demand**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.9.png)
3. Tại phần **Secondary indexes**, nhấp chọn **Create global index** (tạo 2 chỉ mục GSI):
   * **GSI 1:**
     ...
     * **Attribute projections:** **All**
     * Nhấp chọn **Create index**.
     ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.10.png)
   * **GSI 2:**
     ...
     * Nhấp chọn **Create index**.
     ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.11.png)
4. Nhấp chọn **Create table**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.12.png)
5. Sau khi bảng đã tạo xong, bấm vào tên bảng `webquiz-dev-rooms`, chọn tab **Additional settings**:
   * Tại phần **Time to Live (TTL)**, nhấp chọn **Turn on**:
     ...
     * Nhấp chọn **Turn on TTL**.
     ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.13.png)
...
2. Chọn **Customize settings** → Cấu hình co giãn **On-demand**.
 ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.14.png)
3. Tại phần **Secondary indexes**, nhấp chọn **Create global index**:
   * **Partition key:** `roomPin` | **String**
   * **Index name:** `roomPin-index`
   * **Attribute projections:** **All**
   * Nhấp chọn **Create index**.
    ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.15.png)
4. Nhấp chọn **Create table**.
 ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.16.png)
5. Bấm vào bảng `webquiz-dev-connections`, chọn tab **Additional settings**, kích hoạt **Time to Live (TTL)** với tên thuộc tính là `ttl`.
 ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.17.png)
...
2. Chọn **Customize settings** → Cấu hình co giãn **On-demand**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.18.png)
3. Tại phần **Secondary indexes**, nhấp chọn **Create global index**:
   ...
   * **Attribute projections:** **All**
   * Nhấp chọn **Create index**.
   ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.19.png)
4. Nhấp chọn **Create table**.
 ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.20.png)
...
2. Chọn **Customize settings** → Cấu hình co giãn **On-demand**.
 ![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.21.png)
3. Nhấp chọn **Create table**.
![AWS Systems Manager Architecture](/project-aws/images/5-Workshop/5.4/5.4.22.png)
---
