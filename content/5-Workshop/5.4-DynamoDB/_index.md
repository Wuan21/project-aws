...
6. In **Secondary indexes**, click **Create global index**:
   ...
   * Click **Create index**.
![Image 3](/project-aws/images/5-Workshop/5.4/5.4.3.png)
7. Keep encryption defaults and click **Create table**.
![Image 4](/project-aws/images/5-Workshop/5.4/5.4.4.png)
...
![Image 5](/project-aws/images/5-Workshop/5.4/5.4.5.png)
3. In **Secondary indexes**, click **Create global index**:
   ...
   * **Attribute projections:** **All**
   * Click **Create index**.
![Image 6](/project-aws/images/5-Workshop/5.4/5.4.6.png)
4. Click **Create table**.
![Image 7](/project-aws/images/5-Workshop/5.4/5.4.7.png)
...
2. Select **Customize settings** → **On-demand** capacity mode.
![Image 8](/project-aws/images/5-Workshop/5.4/5.4.8.png)
...
2. Select **Customize settings** → **On-demand** capacity mode.
![Image 9](/project-aws/images/5-Workshop/5.4/5.4.9.png)
3. In **Secondary indexes**, click **Create global index** (create 2 GSIs):
   * **GSI 1:**
     ...
     * **Attribute projections:** **All**
     * Click **Create index**.
![Image 10](/project-aws/images/5-Workshop/5.4/5.4.10.png)
   * **GSI 2:**
     ...
     * Click **Create index**.
![Image 11](/project-aws/images/5-Workshop/5.4/5.4.11.png)
4. Click **Create table**.
![Image 12](/project-aws/images/5-Workshop/5.4/5.4.12.png)
5. Once created, select `webquiz-dev-rooms` table, open **Additional settings** tab:
   * Under **Time to Live (TTL)**, click **Turn on**:
     ...
     * Click **Turn on TTL**.
![Image 13](/project-aws/images/5-Workshop/5.4/5.4.13.png)
...
2. Select **Customize settings** → **On-demand** capacity mode.
![Image 14](/project-aws/images/5-Workshop/5.4/5.4.14.png)
3. In **Secondary indexes**, click **Create global index**:
   * **Partition key:** `roomPin` | **String**
   * **Index name:** `roomPin-index`
   * **Attribute projections:** **All**
   * Click **Create index**.
![Image 15](/project-aws/images/5-Workshop/5.4/5.4.15.png)
4. Click **Create table**.
![Image 16](/project-aws/images/5-Workshop/5.4/5.4.16.png)
...
![Image 17](/project-aws/images/5-Workshop/5.4/5.4.17.png)
...
2. Select **Customize settings** → **On-demand** capacity mode.
![Image 18](/project-aws/images/5-Workshop/5.4/5.4.18.png)
3. In **Secondary indexes**, click **Create global index**:
   ...
   * **Attribute projections:** **All**
   * Click **Create index**.
![Image 19](/project-aws/images/5-Workshop/5.4/5.4.19.png)
4. Click **Create table**.
![Image 20](/project-aws/images/5-Workshop/5.4/5.4.20.png)
...
2. Select **Customize settings** → **On-demand** capacity mode.
![Image 21](/project-aws/images/5-Workshop/5.4/5.4.21.png)
3. Click **Create table**.
![Image 22](/project-aws/images/5-Workshop/5.4/5.4.22.png)
